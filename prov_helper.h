...
#define BT_MESH_PROV_HELPER_OP_APPKEY_STATUS	BT_MESH_MODEL_OP_3(0x05, COMPANY_ID)
#define BT_MESH_PROV_HELPER_OP_NETKEY_STATUS	BT_MESH_MODEL_OP_3(0x06, COMPANY_ID)
#define BT_MESH_PROV_HELPER_OP_NODEINFO_STATUS	BT_MESH_MODEL_OP_3(0x07, COMPANY_ID)
#define BT_MESH_PROV_HELPER_OP_ADDRINFO_STATUS	BT_MESH_MODEL_OP_3(0x08, COMPANY_ID)
...
#define BT_MESH_PROV_HELPER_MSG_LEN_APPKEY_STATUS   4
#define BT_MESH_PROV_HELPER_MSG_LEN_NETKEY_STATUS   4
#define BT_MESH_PROV_HELPER_MSG_LEN_NODEINFO_STATUS 4
#define BT_MESH_PROV_HELPER_MSG_LEN_ADDRINFO_STATUS 4
